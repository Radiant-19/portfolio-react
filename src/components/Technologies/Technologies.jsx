...
function Boxes(props) {
  ...
  const textures = [
    ...
    useTexture("/Node.jpg"),
    useTexture("/Next.jpg"),
    useTexture("/matlab.jpeg"),
    useTexture("/Sql.jpg"),
    useTexture("/Mongo.jpg"),
    useTexture("/angular.png"),
    useTexture("/express.png"),
    useTexture("/flask.png"),
  ];
...
const Technologies = () => {
  ...
  return (
    <div className="md:w-10/12 mx-auto w-11/12 py-10" id="technologies">
      <div>
        <div className="bg-gradient-to-r from-[#02020e] to-[#442bd5] inline-block mb-6 rounded-2xl">
          <h2 className="text-3xl p-1 text-gray-200">Technologies</h2>
        </div>
      ...
      <p className="italic text-neutral-300 mt-[-7px]">Technologies I am currently learning:</p>
      <div className="mt-5 grid xl:grid-cols-7 md:grid-cols-5 sm:hrid-cols-4 grid-cols-3 p-5 gap-10"> 
          <div className="max-w-sm overflow-hidden rounded-md shadow-lg shadow-blue-300 p-5">
              <img src="/Django.png" className="pt-5" width={100} height={100}/>
          </div>
          <div className="max-w-sm overflow-hidden rounded-md shadow-lg shadow-blue-300 p-5">    
              <img src="/pytorch.png"  width={100} height={100}/>
          </div>
          <div className="max-w-sm overflow-hidden rounded-md shadow-lg shadow-blue-300 p-5">
